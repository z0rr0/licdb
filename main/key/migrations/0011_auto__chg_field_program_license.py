...
class Migration(SchemaMigration):
    ...
    models = {
        'key.client': {
            ...
            'date_start': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 13, 14, 49, 31, 614034)', 'db_index': 'True'}),
        ...
        'key.key': {
            ...
            'date_start': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 13, 14, 49, 31, 613309)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
