...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Key.use'
        db.delete_column('key_key', 'use')
    ...
    def backwards(self, orm):
        # Adding field 'Key.use'
        db.add_column('key_key', 'use',
    ...
    models = {
        ...
        'key.key': {
            'Meta': {'ordering': "['program__name', 'id']", 'object_name': 'Key'},
            ...
            'date_start': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 11, 0, 0)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
