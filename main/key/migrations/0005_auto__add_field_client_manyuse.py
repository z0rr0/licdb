...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Client.manyuse'
        db.add_column('key_client', 'manyuse', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Client.manyuse'
        db.delete_column('key_client', 'manyuse')
