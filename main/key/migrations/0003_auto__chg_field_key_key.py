...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Key.key'
        db.alter_column('key_key', 'key', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'Key.key'
        db.alter_column('key_key', 'key', self.gf('django.db.models.fields.CharField')(default='', max_length=255, unique=True))
