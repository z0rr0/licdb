...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Key', fields ['manyuse']
        db.create_index('key_key', ['manyuse'])

        # Adding index on 'Key', fields ['key']
        db.create_index('key_key', ['key'])


    def backwards(self, orm):
        
        # Removing index on 'Key', fields ['key']
        db.delete_index('key_key', ['key'])

        # Removing index on 'Key', fields ['manyuse']
        db.delete_index('key_key', ['manyuse'])
    ...
    models = {
        ...
        'key.key': {
            ...
            'date_start': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 5, 16, 7, 33, 39162)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
