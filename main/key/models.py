...
class Key (models.Model):
    ...
    use = models.PositiveIntegerField(verbose_name = u'использовано', default = 0, help_text = u'сколько раз ключ уже использован', db_index=True)
